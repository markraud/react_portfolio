          ...
          <div className="col s12 m12 center-align">
            <div className="card blue-grey darken-1">
              ...
              <div className="card-action">
                ...
                <a href="https://www.linkedin.com/in/markraudenbush/" className="waves-effect waves-light btn blue-grey darken-3" target="_blank"><i className="fa fa-linkedin fa-2x" /></a>
                <a href="https://github.com/markraud" className="waves-effect waves-light btn blue-grey darken-3" target="_blank"><i className="fa fa-github fa-2x" /></a>
